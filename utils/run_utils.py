...
def call_experiment(exp_name, thunk, seed=0, data_dir=None, datestamp=False, **kwargs):
    """
    ...
    test_cmd = "python utils/test_policy.py " + logger_kwargs["output_dir"]
...
class ExperimentGrid:
    ...
    def run(self, thunk, data_dir=None, datestamp=False):
        ...
        for var in variants:
            ...
            call_experiment(
                exp_name, thunk_, data_dir=data_dir, datestamp=datestamp, **var
            )
